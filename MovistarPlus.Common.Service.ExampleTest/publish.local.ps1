...
$ServiceName = "MovistarPlus.Common.ExampleTest.Local"
...
&'C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\MSBuild\Current\Bin\MSBuild.exe' .\MovistarPlus.Common.Service.ExampleTest.csproj /t:Clean /t:Rebuild /p:Configuration=Debug > compillation.output
&'C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\MSBuild\Current\Bin\MSBuild.exe' .\MovistarPlus.Common.Service.ExampleTest.csproj /t:Build /p:Configuration=Debug
...
if ($ServicioInstalado)
{
	...
	taskkill /F /IM "MovistarPlus.Common.Service.exe" /T
} else {
...
Copy-item App.config $ProgramPublishLocation\MovistarPlus.Common.Service.exe.config
